...
impl SysCatalog {
    ...
    pub fn init() -> RsqlResult<()> {
        ...
        tnx_manager::TnxManager::global().end_transaction(0);
        Ok(())
    }
...
mod tests {
    use super::*;
    use crate::db::{table_schema::ColType, tnx_manager::TnxManager};
    ...
    fn test_reg_table() {
        ...
        tnx_manager::TnxManager::global().end_transaction(1);
    }
    ...
    fn test_user_management() {
        ...
        tnx_manager::TnxManager::global().end_transaction(2);
    }
    ...
    fn test_system_tables_init() {
        let catalog = setup_test_catalog();
        let _ = tnx_manager::TnxManager::global()
        ...
        tnx_manager::TnxManager::global().end_transaction(3);
    }
}
